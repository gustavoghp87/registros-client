    ...
    return (
        ...
        <div className="container" style={{maxWidth:'95%'}}>
            ...
            <div className="container" style={{paddingTop:'15px', display:'block', margin:'auto', maxWidth:'500px'}}>
                ...
                <form action={`${SERVER}/api/users/login`} method="POST" style={{display:'block', margin:'auto'}} id="demo-form">

                    <input className="form-control" type="email" name="email" style={{marginBottom:'12px'}} placeholder="Correo electrónico" id="emailForm" autoFocus />

                    <input className="form-control" type="password" name="password" style={{marginBottom:'30px'}} placeholder="Contraseña" />
