...
export const SERVER: string = isLocalhost ? "http://localhost:4005" : "https://registros-rest-api.herokuapp.com" // production server will not respond because cors policies
